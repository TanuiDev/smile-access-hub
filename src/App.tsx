...
import { Toaster as Sonner } from "@/components/dashboards/ui/sonner";
import { TooltipProvider } from "@/components/dashboards/ui/tooltip";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/prescriptions/new" element={<ProtectedRoute><PrescriptionNew /></ProtectedRoute>} />
